...
const isEditBypassTarget = (target) => {
  ...
  return Boolean(
    target.closest("#toggle-edit, #manual-save, #export-sheet, #import-sheet, .set-active, .active-slot-btn, .move-tab, #signature-move-preview, .move-tile__preview, #back-to-top-button")
  );
};
